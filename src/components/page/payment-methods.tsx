  ...
  },
  {
    ...
    icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-black" viewBox="0 0 24 24" fill="currentColor">
            <path d="M10.1,6.54c-2.43,0-4.4,1.97-4.4,4.4s1.97,4.4,4.4,4.4s4.4-1.97,4.4-4.4S12.53,6.54,10.1,6.54z M10.1,13.54 c-1.5,0-2.7-1.2-2.7-2.7s1.2-2.7,2.7-2.7s2.7,1.2,2.7,2.7S11.6,13.54,10.1,13.54z M20,10.94v2.2h-1.83 c-0.28,2.8-2.63,5.03-5.46,5.19v1.83h-2.2v-1.83c-2.8-0.28-5.03-2.63-5.19-5.46H3.5v-2.2h1.83c0.28-2.8,2.63-5.03,5.46-5.19V3.54h2.2v1.83c2.8,0.28,5.03,2.63,5.19,5.46H20z M14.3,10.94c-0.22-2.25-2.1-4-4.39-4s-4,1.75-4.21,4H14.3z"/>
        </svg>
    ),
  },
];
