      ...
      <Card>
        ...
        <CardContent>
          ...
          <ul className="ml-5 mt-2 list-disc space-y-1 text-sm text-muted-foreground">
            <li>
              <strong>30 páginas</strong> com desenhos originais e
              ilustrativos;
            </li>
            <li>
              Temas: animais fofos, natureza sonhadora, doces e cenas
              acolhedoras;
            </li>
            <li>
              Arquivos em PDF simples, pronto para imprimir ou colorir no
              tablet;
            </li>
            <li>
              Atendimento para todas as idades — ótimo para relaxar, aulas, ou
              momentos em família.
            </li>
          </ul>
          ...
          <h2 className="mt-6 text-xl font-semibold tracking-tight">Como usar</h2>
